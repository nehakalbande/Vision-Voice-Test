...
class _e3State extends State<e3> {
  ...
  void _loadSound() async {
    final ByteData data = await rootBundle.load('assets/513_3.wav');
    Directory tempDir = await getTemporaryDirectory();
    File tempFile = File('${tempDir.path}/513_3.wav');
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  RaisedButton(
                    onPressed: (){
                      Navigator.push(context,
                          MaterialPageRoute(builder: (_) =>e4()));
                    },
